...
$FASTBPE_DIR/fast getvocab $DATA_DIR/train.bpe.en $DATA_DIR/train.bpe.bn > $DATA_DIR/vocab.en
```
...
cat $OUTFILENAME.bn | sacrebleu ~/scripts/chat_en_hi/data/data/wmt20_chat/test.bn  -m bleu ter
